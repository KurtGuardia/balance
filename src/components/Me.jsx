  ...
  return (
    <div className='me' id='me'>
      ...
      <p>
        ...
        personalizada de acuerdo con las características de
        cada paciente, sin embargo, sentía que faltaban
        piezas fundamentales para un entendimiento{' '}
        <b> más profundo de la salud;</b> es así como decidí
        formarme en dos<i> apasionantes áreas</i> que son
        clave y que están muy relacionadas con el estado de
      ...
      <div className='me_content_area'>
        ...
        <p className='me_content_area-text'>
          Es la ciencia que estudia la comunicación entre
          nuestros procesos psicológicos y los sistemas que
          mantienen el equilibrio nuestro organismo: el
          sistema nervioso, el endocrino y el inmune. De
          este campo nacen las Terapias Mente-Cuerpo,
          intervenciones que emplean diferentes técnicas
          para potenciar la capacidad de la mente para
      ...
      <div className='me_content_area'>
        ...
        <p className='me_content_area-text'>
          ...
          comunicación con el sistema inmunológico, influye
          en el metabolismo y en la producción de
          neurotransmisores siendo un factor clave en el
          estado de salud físico, mental y emocional,
          pilares fundamentales del bienestar de todo ser
          humano.
        </p>
      ...
      <p>
        {/* El combinar e integrar la nutrición con estas
          ...
          entorno. <br /> */}
        <b>Abordar la salud de una manera más holística</b>
