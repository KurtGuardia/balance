  ...
  return (
    <div className='me' id='me'>
      ...
      <p>
        ...
        intestinal, que son clave y que están muy
        relacionadas con el estado de salud de cualquier
        persona
      </p>
      <div className='me_areas'>
        <div className='me_areas_area'>
          ...
          >
            ...
            {/* <span className='me_areas_area-title-svg'>
              <Dropdown />
            </span> */}
          </p>
          {pnieOpen && (
      ...
      <p>
        ...
        manera más holística apoyándonos en una alimentación
        y estilo de vida consiente. Consciente con nosotros
        mismos y con nuestro entorno. Este es el enfoque con
